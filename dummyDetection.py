...
def objectDetection(thresholdConfidence):
    ...
    for i in range(1): #for loop
        ...
        camera.capture('/home/pi/Downloads/' + capturedImage + '.jpeg')
        camera.stop_preview()
        """
        #this is the openCV code for reading in image
        image = cv2.imread("/home/pi/Downloads/donuts.jpg")
        ...
        cv2.imwrite("/home/pi/Downloads/AppleswithBoxes.jpg",image)
